                    ...
                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                        ...
                        <thead style="background: #F9FAFB;">
                            <tr>
                                <th>No.</th>
                                <th>Kiosk Number</th>
                                <th>@lang('crud.kiosks.inputs.name')</th>
                                <th>@lang('crud.kiosks.inputs.location')</th>
                                <th>@lang('crud.kiosks.inputs.business_type_id')</th>
                                <th>@lang('crud.kiosks.inputs.status')</th>
                                <th>Action</th>
                            </tr>
                        </thead>
